...
part of 'favorite_movies_data.dart';
...
mixin _$FavoriteMoviesData {
  ...
  @JsonKey(ignore: true)
  $FavoriteMoviesDataCopyWith<FavoriteMoviesData> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FavoriteMoviesDataCopyWith<$Res> {
  factory $FavoriteMoviesDataCopyWith(
          FavoriteMoviesData value, $Res Function(FavoriteMoviesData) then) =
      _$FavoriteMoviesDataCopyWithImpl<$Res, FavoriteMoviesData>;
  @useResult
  $Res call(
...
/// @nodoc
class _$FavoriteMoviesDataCopyWithImpl<$Res, $Val extends FavoriteMoviesData>
    implements $FavoriteMoviesDataCopyWith<$Res> {
  _$FavoriteMoviesDataCopyWithImpl(this._value, this._then);
...
class __$$_MoviesCopyWithImpl<$Res>
    extends _$FavoriteMoviesDataCopyWithImpl<$Res, _$_Movies>
...
class _$_Movies implements _Movies {
  ...
  @override
  String toString() {
    return 'FavoriteMoviesData(page: $page, results: $results, totalPages: $totalPages, totalResults: $totalResults)';
  }
...
abstract class _Movies implements FavoriteMoviesData {
  const factory _Movies(
      {final int? page,
      final List<Result>? results,
      final int? totalPages,
      final int? totalResults}) = _$_Movies;
